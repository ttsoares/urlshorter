...
const Features = () => {
  return (
    <section className="w-full flex flex-col items-center justify-between mx-auto bg-[#F1F4F9] border-2 border-yellow-400">
      <div className="container w-[90%] lg:w-[80%] flex flex-col items-center justify-between mx-auto">
        <div className="w-full py-24 bg-gray-100">
          <div className="container mx-auto px-3">
            <h2 className="text-[2.5rem] text-veryDarkBlue mb-6 mt-3 font-bold text-center">
              Advanced Statistics
            </h2>
          ...
          <div className="relative container flex flex-col items-start px-6 mx-auto md:flex-row md:space-x-7">
            ...
            <div className="relative flex flex-col p-6 space-y-6 bg-white rounded-lg md:w-1/3">
              <div className="absolute -ml-10 left-1/2 -top-10 md:left-16">
                <div className="flex items-center justify-center w-[84px] h-20 p-4 rounded-full bg-veryDarkBlue">
                  <Image
